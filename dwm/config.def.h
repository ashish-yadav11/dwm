...
static const Key keys[] = {
	...
	{ MODLKEY,                      XK_e,           setlayout,              {.v = &layouts[0]} },
	{ MODLKEY|ShiftMask,            XK_e,           setlayout,              {.v = &layouts[1]} },
	{ MODLKEY|ControlMask,          XK_e,           setlayout,              {.v = &layouts[4]} },
	{ MODLKEY,                      XK_w,           setlayout,              {.v = &layouts[2]} },
	{ MODLKEY|ShiftMask,            XK_w,           setlayout,              {.v = &layouts[3]} },
	{ MODLKEY|ControlMask,          XK_w,           setlayout,              {.v = &layouts[5]} },
	{ MODLKEY,                      XK_t,           setlayout,              {0} },
