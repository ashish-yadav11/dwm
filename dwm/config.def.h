...
static const Key keys[] = {
	...
	{ MODLKEY,                      XK_y,           scratchtoggle,          {.i = 8} },
	{ MODLKEY,                      XK_u,           scratchtoggle,          {.i = 9} },
	{ SUPKEY,                       XK_y,           dynscratchtoggle,       {.i = DYNSCRATCHKEY(1) } },
	{ SUPKEY|ShiftMask,             XK_y,           dynscratchunmark,       {.i = DYNSCRATCHKEY(1) } },
	{ SUPKEY,                       XK_u,           dynscratchtoggle,       {.i = DYNSCRATCHKEY(2) } },
	{ SUPKEY|ShiftMask,             XK_u,           dynscratchunmark,       {.i = DYNSCRATCHKEY(2) } },
	{ SUPKEY,                       XK_i,           dynscratchtoggle,       {.i = DYNSCRATCHKEY(3) } },
	{ SUPKEY|ShiftMask,             XK_i,           dynscratchunmark,       {.i = DYNSCRATCHKEY(3) } },
	{ SUPKEY|ControlMask,           XK_y,           spawn,                  SCRIPTCMD("dynscript.sh", "y") },
	{ SUPKEY|ControlMask,           XK_u,           spawn,                  SCRIPTCMD("dynscript.sh", "u") },
	{ SUPKEY|ControlMask,           XK_i,           spawn,                  SCRIPTCMD("dynscript.sh", "i") },
